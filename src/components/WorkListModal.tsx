...
const WorkListModal: React.FC<CustomModalProps> = ({ isOpen, onRequestClose, contentLabel }) => {
    ...
    return (
        <>
            ...
            <WorkDetailModal isOpen={modalIsOpen1} onRequestClose={closeModal} contentLabel="공작도 리스트 상세" />
            <WorkRegistModal isOpen={modalIsOpen2} onRequestClose={closeModal} contentLabel="공작도 등록" />
        </>
    );
};
