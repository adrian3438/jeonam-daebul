...
!function(a) {
    ...
    return function b(a, c, d) {
        ...
        2: [function(a, b, c) {
            ...
            function e(a, b) {
                try {
                    b && (b.width = a.width,
                    b.height = a.height,
                    b.getContext("2d").putImageData(a.getContext("2d").getImageData(0, 0, a.width, a.height), 0, 0))
                } catch (c) {
                ...
                new Promise(function(b) {
                    ...
                    l.contentWindow.onload = l.onload = function() {
                        var a = setInterval(function() {
                            c.body.childNodes.length > 0 && (g(c.documentElement),
                            clearInterval(a),
        ...
        6: [function(a, b, c) {
            function d(a, b) {
                var c, d, f = document.createElement("div"), g = document.createElement("img"), h = document.createElement("span"), i = "Hidden Text";
        ...
        9: [function(a, b, c) {
            ...
            d.REGEXP_COLORSTOP = /^\s*(rgba?\(\s*\d{1,3},\s*\d{1,3},\s*\d{1,3}(?:,\s*[0-9\.]+)?\s*\)|[a-z]{3,20}|#[a-f0-9]{3,6})(?:\s+(\d{1,3}(?:\.\d+)?)(%|px)?)?(?:\s|$)/i,
            b.exports = d
        }
        , {}],
        10: [function(a, b, c) {
        ...
        14: [function(a, b, c) {
            ...
            d.prototype.parseBackgroundSize = function(a, b, c) {
                ...
                return e = "auto" === f[0] && "auto" === f[1] ? b.height : "auto" === f[1] ? d / b.width * b.height : g(f[1]) ? a.height * parseFloat(f[1]) / 100 : parseInt(f[1], 10),
            ...
            d.prototype.parseBackgroundPosition = function(a, b, c, d) {
                ...
                return e = g(h[0]) ? (a.width - (d || b).width) * (parseFloat(h[0]) / 100) : parseInt(h[0], 10),
                f = "auto" === h[1] ? e / b.width * b.height : g(h[1]) ? (a.height - (d || b).height) * parseFloat(h[1]) / 100 : parseInt(h[1], 10),
        ...
        15: [function(a, b, c) {
            function d(a, b, c, d, e) {
                ...
                var f = new Q(a,null);
                if (e.background && b.rectangle(0, 0, b.width, b.height, new U(e.background)),
                ...
                this.nodes = J([f].concat(this.getChildren(f)).filter(function(a) {
            ...
            d.prototype.getPseudoElement = function(a, b) {
                ...
                if (g.className = S.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + S.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER,
                e)
                    return g.src = Z(d)[0].args[0],
                    [h];
            ...
            d.prototype.parse = function(a) {
                ...
                b.concat(e).concat(f).concat(h).concat(i).concat(j).concat(k).forEach(function(a) {
                    ...
                    r(a) && (this.parse(a),
                    this.renderQueue.push(new g))
                }, this)
            }
            ,
            d.prototype.paint = function(a) {
                try {
                    a instanceof g ? this.renderer.ctx.restore() : D(a) ? (C(a.parent) && a.parent.appendToDOM(),
                    this.paintText(a),
                    C(a.parent) && a.parent.cleanDOM()) : this.paintNode(a)
                } catch (b) {
                    if (O(b),
                    this.options.strict)
                        throw b
            ...
            d.prototype.paintNode = function(a) {
                r(a) && (this.renderer.setOpacity(a.opacity),
            ...
            d.prototype.paintCheckbox = function(a) {
                var b = a.parseBounds()
                  ...
                  , i = j(d, f, g);
                this.renderer.clip(a.backgroundClip, function() {
                    this.renderer.rectangle(d.left + 1, d.top + 1, d.width - 2, d.height - 2, new U("#DEDEDE")),
                    this.renderer.renderBorders(h(g, d, i, f)),
                    a.node.checked && (this.renderer.font(new U("#424242"), "normal", "normal", "bold", c - 3 + "px", "arial"),
            ...
            d.prototype.paintRadio = function(a) {
                ...
                this.renderer.clip(a.backgroundClip, function() {
                    this.renderer.circleStroke(b.left + 1, b.top + 1, c, new U("#DEDEDE"), 1, new U("#A5A5A5")),
                    a.node.checked && this.renderer.circle(Math.ceil(b.left + c / 4) + 1, Math.ceil(b.top + c / 4) + 1, Math.floor(c / 2), new U("#424242"))
                }, this)
            }
            ,
            ...
            d.prototype.paintText = function(a) {
                ...
                this.renderer.clip(a.parent.clip, function() {
                    c.map(this.parseTextBounds(a), this).forEach(function(b, d) {
                        b && (this.renderer.text(c[d], b.left, b.bottom),
                        this.renderTextDecoration(a.parent, b, this.fontMetrics.getMetrics(f, e)))
                    }, this)
                }, this)
            }
            ,
            ...
            d.prototype.parseBackgroundClip = function(a, b, c, d, e) {
                ...
                case "content-box":
                case "padding-box":
                    m(g, d[0], d[1], b.topLeftInner, b.topRightInner, e.left + c[3].width, e.top + c[0].width),
                    m(g, d[1], d[2], b.topRightInner, b.bottomRightInner, e.left + e.width - c[1].width, e.top + c[0].width),
                    m(g, d[2], d[3], b.bottomRightInner, b.bottomLeftInner, e.left + e.width - c[1].width, e.top + e.height - c[2].width),
                    m(g, d[3], d[0], b.bottomLeftInner, b.topLeftInner, e.left + c[3].width, e.top + e.height - c[2].width);
                    break;
                default:
                    ...
                    m(g, d[2], d[3], b.bottomRightOuter, b.bottomLeftOuter, e.left + e.width, e.top + e.height),
            ...
            function i(a) {
                return function(b) {
                    ...
                    if (!g || !g.href.host) {
                        ...
                        h.href = a,
                        c.head.insertBefore(h, c.head.firstChild)
                    }
                    return c
                }
            }
        ...
        17: [function(a, b, c) {
            function d(a, b) {
                ...
                this.promise = new Promise(function(c, f) {
                    ...
                    d.image.onload = c,
                    d.image.onerror = f,
                    new e(a,b,document).then(function(a) {
                        d.image.src = a
                    })["catch"](f)
                }
                )
        ...
        23: [function(a, b, c) {
            ...
            d.prototype.createCanvas = function(a) {
                ...
                return function(c, d) {
                    ...
                    e.setWidth(d.width).setHeight(d.height).add(window.html2canvas.svg.fabric.util.groupSVGElements(c, d)).renderAll(),
                    a(e.lowerCanvasEl)
                }
            }
            ,
