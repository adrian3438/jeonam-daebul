...
//                 document.getElementById("dk_psc_image_pdsFile").value = json.pscImagepdsFilename;
...
// // @@ 서브 카테고리 삭제 START
// function pscDelete(subIdx, loopCnt) {
//     // 정말삭제하시겠습니까 ? 
...
//                 document.getElementById("dk_pdc_image_pdsFile").value = json.pdcImagepdsFilename;
...
//     console.log("SubIdx in Delete : "+subIdx);
...
//                 document.getElementById("dk_ppc_image_pdsFile").value = json.ppcImagepdsFilename;
...
$(function(){
	...
	$fileInput.on('change', function() {
		...
		if (filesCount === 1) {
			...
			$(this).parents('.attachments_area').find('.img-preview-area').find('img').attr('src' , '');
			$textContainer.text(filesCount + ' files selected');
		}

		readURL(this);
		// $(this).parents('.file-drop-area').css({ 'display' : '' })
